...
class _NodeEditScreenState extends State<NodeEditScreen> {
  static const _standardTypes = ['ss', 'ssr', 'vmess', 'vless', 'trojan'];
  ...
  bool get _usesPassword => {'ss', 'ssr', 'trojan'}.contains(_type);
  ...
  bool get _usesSni => {'vmess', 'vless', 'trojan'}.contains(_type);
  ...
  Future<void> _save() async {
    ...
    if (_usesSni) {
      final sniKey = _type == 'trojan' ? 'sni' : 'servername';
